...
BOT_TOKEN = "8431256004:AAEd40mYmlMaJPXuQiSoZbrokaoRTm2QIec"
...
async def removexpiredtoken_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(expired_list, parse_mode="Markdown")
...
async def remove_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❌ ɪɴᴠᴀʟɪᴅ ᴜsᴇʀ ɪᴅ", parse_mode="Markdown")
...
async def gentrailkey_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❌ ɪɴᴠᴀʟɪᴅ ɴᴜᴍʙᴇʀ ᴏғ ʜᴏᴜʀs", parse_mode="Markdown")
...
async def setmaxattack_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if max_attacks < 1 or max_attacks > 1000:
            await update.message.reply_text("❌ ᴍᴀxɪᴍᴜᴍ ᴀᴛᴛᴀᴄᴋs ᴍᴜsᴛ ʙᴇ ʙᴇᴛᴡᴇᴇɴ 1 ᴀɴᴅ 100", parse_mode="Markdown")
            return
...
async def userslist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not approved_users:
        await update.message.reply_text("📭 ɴᴏ ᴀᴘᴘʀᴏᴠᴇᴅ ᴜsᴇʀs", parse_mode="Markdown")
        return
...
async def maintenance_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if mode == "on":
        ...
        await update.message.reply_text("❌ ɪɴᴠᴀʟɪᴅ ᴍᴏᴅᴇ. ᴜsᴇ 'ᴏɴ' ᴏʀ 'ᴏғғ'", parse_mode="Markdown")
...
async def setcooldown_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if new_cooldown < 10:
            await update.message.reply_text("❌ ᴄᴏᴏʟᴅᴏᴡɴ ᴍᴜsᴛ ʙᴇ ᴀᴛ ʟᴇᴀsᴛ 10 sᴇᴄᴏɴᴅs", parse_mode="Markdown")
            return
...
async def add_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❌ ɪɴᴠᴀʟɪᴅ ᴜsᴇʀ ɪᴅ ᴏʀ ᴅᴀʏs", parse_mode="Markdown")
...
async def approveuserslist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not pending_users:
        await update.message.reply_text("📭 ɴᴏ ᴘᴇɴᴅɪɴɢ ʀᴇǫᴜᴇsᴛs", parse_mode="Markdown")
        return
...
async def ownerlist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(owners_list, parse_mode="Markdown")
...
async def adminlist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not admins:
        await update.message.reply_text("📭 ɴᴏ ᴀᴅᴍɪɴs", parse_mode="Markdown")
        return
...
async def resellerlist_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not resellers:
        await update.message.reply_text("📭 ɴᴏ ʀᴇsᴇʟʟᴇʀs", parse_mode="Markdown")
        return
    ...
    await update.message.reply_text(resellers_list, parse_mode="Markdown")
...
async def listgrp_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not groups:
        await update.message.reply_text("📭 ɴᴏ ɢʀᴏᴜᴘs", parse_mode="Markdown")
        return
...
async def broadcast_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_owner(user_id):
        await update.message.reply_text("⚠️ ᴘᴇʀᴍɪssɪᴏɴ ᴅᴇɴɪᴇᴅ", parse_mode="Markdown")
...
async def addreseller_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❌ ɪɴᴠᴀʟɪᴅ ᴜsᴇʀ ɪᴅ ᴏʀ ᴄʀᴇᴅɪᴛs", parse_mode="Markdown")
    ...
    try:
        for existing_token in github_tokens:
            if existing_token['token'] == token:
                await update.message.reply_text("❌ ᴛᴏᴋᴇɴ ᴀʟʀᴇᴀᴅʏ ᴇxɪsᴛs.", parse_mode="Markdown")
                return
        ...
        await update.message.reply_text(f"❌ **ᴇʀʀᴏʀ**\n━━━━━━━━━━━━━━━━━━━━━━\n{str(e)}\nᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ᴛᴏᴋᴇɴ.", parse_mode="Markdown")
...
async def tokens_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not github_tokens:
        await update.message.reply_text("📭 ɴᴏ ᴛᴏᴋᴇɴs ᴀᴅᴅᴇᴅ ʏᴇᴛ.", parse_mode="Markdown")
        return
...
async def removetoken_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if token_num < 1 or token_num > len(github_tokens):
            await update.message.reply_text(f"❌ ɪɴᴠᴀʟɪᴅ ɴᴜᴍʙᴇʀ. ᴜsᴇ 1-{len(github_tokens)}", parse_mode="Markdown")
            return
...
async def handle_binary_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not update.message.document:
        await update.message.reply_text("❌ ᴘʟᴇᴀsᴇ sᴇɴᴅ ᴀ ғɪʟᴇ, ɴᴏᴛ ᴛᴇxᴛ.", parse_mode="Markdown")
        return WAITING_FOR_BINARY
    
    progress_msg = await update.message.reply_text("📥 **ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ʙɪɴᴀʀʏ ғɪʟᴇ...**", parse_mode="Markdown")
